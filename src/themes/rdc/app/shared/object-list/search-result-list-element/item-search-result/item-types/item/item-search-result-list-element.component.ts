...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'rdc')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'rdc')
@Component({
